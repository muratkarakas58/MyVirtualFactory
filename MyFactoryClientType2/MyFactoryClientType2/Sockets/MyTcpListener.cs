...
namespace MyFactoryClientType2.Sockets
{
    public class MyTcpListener
    {
        public static void Listen()
        {
            TextBox textBoxListen = Application.OpenForms["FormMyFactoryClientType2"].Controls["textBoxListen"] as TextBox;

            TcpListener server = null;
            try
            {
                TextBox textBoxMyIp = Application.OpenForms["FormMyFactoryClientType2"].Controls["textBoxMyIp"] as TextBox;               

                TextBox textBoxMyPort = Application.OpenForms["FormMyFactoryClientType2"].Controls["textBoxMyPort"] as TextBox;
